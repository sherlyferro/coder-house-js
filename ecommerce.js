...
if (Edad > 17) {
  ...
  function agregaCarrito() {
    let elegirProducto = prompt(
      "Si desea elegir algun producto coloque el numero correspondiente a : 0  ,  1 ,2  ,3  ,4 o 5 \n y  para salir introdusca el número 100 "
    );
    while (isNaN(elegirProducto)) {
      alert("Porfavor ingrese solo números");

      elegirProducto = prompt(
        "Si desea elegir algun producto coloque el numero correspondiente 0  ,  1 ,2  ,3  ,4 o 5 \n  y para salir introdusca el número 100 "
      );
    }
    ...
    while (elegirProducto != 100) {
      switch (parseInt(elegirProducto)) {
        case 0:
          ...
          alert(
            `Agregamos a tu carrito el producto ${productosTienda[0].nombre}`
          );
        ...
        case 1:
          ...
          alert(
            `Agregamos a tu carrito el producto ${productosTienda[1].nombre}`
          );
        ...
        case 2:
          ...
          alert(
            `Agregamos a tu carrito el producto ${productosTienda[2].nombre}`
          );
        ...
        case 3:
          ...
          alert(
            `Agregamos a tu carrito el producto ${productosTienda[3].nombre}`
          );
        ...
        case 4:
          ...
          alert(
            `Agregamos a tu carrito el producto ${productosTienda[4].nombre}`
          );
        ...
        case 5:
          ...
          alert(
            `Agregamos a tu carrito el producto ${productosTienda[5].nombre}`
          );
